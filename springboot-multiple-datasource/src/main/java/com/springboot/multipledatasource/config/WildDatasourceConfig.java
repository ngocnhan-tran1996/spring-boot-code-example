...
public class WildDatasourceConfig {
  ...
  private static final String BASE_PACKAGE = "com.springboot.multipledatasource.wild";
  ...
  DataSourceInitializer wildDatasourceInitializer() {
    ...
    resourceDatabasePopulator.addScript(new ClassPathResource("wild-data.sql"));
