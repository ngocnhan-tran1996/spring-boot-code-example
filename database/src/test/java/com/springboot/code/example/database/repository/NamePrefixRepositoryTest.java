package com.springboot.code.example.database.repository;
...
class NamePrefixRepositoryTest {
  ...
  @TestCase("com.springboot.code.example.database.repository.testcase.NamePrefixRepositoryTestArguments#testExecuteNameInfoArguments")
  ...
  @TestCase("com.springboot.code.example.database.repository.testcase.NamePrefixRepositoryTestArguments#testBindParameterArguments")
